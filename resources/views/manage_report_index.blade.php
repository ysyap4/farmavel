...
<head>
    ...
    <title>Farmavel | Manage Report</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <a class="btn btn-primary" href="{{URL::route('manage_report_create')}}">Add</a>
                        <a class="btn btn-primary" onClick="manage_report_show()">Show</a>
                        <a class="btn btn-primary" onClick="manage_report_edit()">Edit</a>
                        <button class="btn btn-primary" id="manage_report_delete" onClick="manage_report_delete()">Delete</button>
                    ...
                    <tr>
                        <td style="text-align: center;"><div class="checkbox i-checks"> <input type="checkbox" name="selected_rep[]" value="{{ $value->id }}" id="selected_rep"> <i></i> </div></td>
    ...
    function manage_report_show()
    {
        var x =[];

        if (this.checked)
        {
          $('#selected_rep').removeAttr('disabled');
        ...
        x = document.getElementById("selected_rep").value;
        document.get_checkbox.action = "{{URL::route('manage_report_show')}}";
        document.get_checkbox.submit();
    }
    </script>

    <script type="text/javascript">
    function manage_report_edit()
    {
        var x =[];
        ...
        x = document.getElementById("selected_rep").value;
        document.get_checkbox.action = "{{URL::route('manage_report_edit')}}";
        document.get_checkbox.submit();
    }
    </script>

    <script type="text/javascript">
    function manage_report_delete()
    {
        var x =[];

        $('button#manage_report_delete').on('click',
            function(){
              swal({
               title: "Are you sure?",
              ...
              function(){
                ...
                x = document.getElementById("selected_rep").value;
                document.get_checkbox.action = "{{URL::route('manage_report_delete')}}";
                document.get_checkbox.submit();
