            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <th><div class="col-sm-3"></div>Name</th>
                        <th>Email</th>
                        <th>Phone</th>
                        <th>Type</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-2">
                                <img alt="image" class="img-circle" src="{{URL::asset(Storage::disk('s3')->url('farmavel/user_image/' .$value->image))}}" style="height:25px; width:25px;">
                            </div>
                            <div class="col-sm-10">
                                {{ $value->name }}
                            </div>
