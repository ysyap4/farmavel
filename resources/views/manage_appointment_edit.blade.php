...
<head>
    ...
    <title>Farmavel | Edit Appointment</title>
...
<body>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
    <form method="POST" class="form-horizontal" name="manage_appointment_edit_process" id="manage_appointment_edit_process" action="{{ URL::route ('manage_appointment_edit_process')}}">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    @for ($i=0; $i < sizeof($edit_selected_app); $i++)
                <div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit Appointment ID {{$edit_selected_app[$i]->id}} </h5>
                            <input type="hidden" name="edit_selected_app[]" value="{{ $edit_selected_app[$i]->id }}">
                        ...
                        <div class="ibox-content">
                                <div class="form-group{{ $errors->has('user_name') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Client Name</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="user_name[]" class="form-control" name="user_name[]" placeholder="Client Name" value="{{$get_selected_user[$i]->name}}">
                                ...
                                <div class="form-group{{ $errors->has('med_name') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Medicine Name</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="med_name[]" class="form-control" name="med_name[]" placeholder="Medicine Name" value="{{$get_selected_med[$i]->med_name}}">
                                ...
                                <div class="form-group{{ $errors->has('app_date') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Date</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="app_date[]" class="form-control" name="app_date[]" placeholder="Date" value="{{$edit_selected_app[$i]->app_date}}">
                                ...
                                <div class="form-group{{ $errors->has('app_time') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Time</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="app_time[]" class="form-control" name="app_time[]" placeholder="Time" value="{{$edit_selected_app[$i]->app_time}}">
                                ...
                                <div class="form-group{{ $errors->has('app_location') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Location</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="app_location[]" class="form-control" name="app_location[]" placeholder="Location" value="{{$edit_selected_app[$i]->app_location}}">
                                ...
                                <div class="form-group{{ $errors->has('app_method') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Method</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="app_method[]" class="form-control" name="app_method[]" placeholder="Method" value="{{$edit_selected_app[$i]->app_method}}">
