                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"><h4 class="m-t-none m-b">Select range <small>to be displayed.</small> </h4>
                                    ...
                                    <div class="form-group">
                                        <br><br>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" id="submit_periodic" type="submit" onClick="submit_periodic()"><strong>Submit</strong>
                                        </button>
                                    </div>
                                </form>
                            </div>
