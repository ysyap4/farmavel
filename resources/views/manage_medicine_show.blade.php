                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        @if (is_null($show_selected_med[$i]->med_image))
                                            <img alt="image" class="img-circle" style="height:250px; width:250px;" src="{{URL::asset('medicine_image/no_image.jpg')}}"/>
                                        @else
                                            <img alt="image" class="img-circle" style="height:250px; width:250px;" src="{{URL::asset(Storage::disk('s3')->url('medicine_image/' . $show_selected_med[$i]->med_image))}}">
                                        @endif
                                    </div>
