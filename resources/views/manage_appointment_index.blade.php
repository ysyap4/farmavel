...
<head>
    ...
    <title>Farmavel | Manage Appointment</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <a class="btn btn-primary" href="{{URL::route('manage_appointment_create')}}">Add</a>
                        <a class="btn btn-primary" onClick="manage_appointment_show()">Show</a>
                        <a class="btn btn-primary" onClick="manage_appointment_edit()">Edit</a>
                        <button class="btn btn-primary" id="manage_appointment_delete" onClick="manage_appointment_delete()">Delete</button>
                    ...
                    <tr>
                        <td style="text-align: center;"><div class="checkbox i-checks"> <input type="checkbox" name="selected_app[]" value="{{ $value->id }}" id="selected_app"> <i></i> </div></td>
                        ...
                        <td>{{ $value->app_location }}</td>
                        <td>{{ $value->app_method }}</td>
                    </tr>
                        <?php $no++; ?>
                        @endforeach
                    </tbody>
    ...
    function manage_appointment_show()
    {
        var x =[];

        if (this.checked)
        {
          $('#selected_app').removeAttr('disabled');
        ...
        x = document.getElementById("selected_app").value;
        document.get_checkbox.action = "{{URL::route('manage_appointment_show')}}";
        document.get_checkbox.submit();
    }
    </script>

    <script type="text/javascript">
    function manage_appointment_edit()
    {
        var x =[];
        ...
        x = document.getElementById("selected_app").value;
        document.get_checkbox.action = "{{URL::route('manage_appointment_edit')}}";
        document.get_checkbox.submit();
    }
    </script>

    <script type="text/javascript">
    function manage_appointment_delete()
    {
        var x =[];

        $('button#manage_appointment_delete').on('click',
            function(){
              swal({
               title: "Are you sure?",
              ...
              function(){
                ...
                x = document.getElementById("selected_app").value;
                document.get_checkbox.action = "{{URL::route('manage_appointment_delete')}}";
                document.get_checkbox.submit();
