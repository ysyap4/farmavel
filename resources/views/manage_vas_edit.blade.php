...
<head>
    ...
    <title>Farmavel | Edit Value-Added Service</title>
...
<body>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
    <form method="POST" class="form-horizontal" name="manage_vas_edit_process" id="manage_vas_edit_process" action="{{ URL::route ('manage_vas_edit_process')}}">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    @for ($i=0; $i < sizeof($edit_selected_vas); $i++)
                <div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit Value-Added Service ID {{$edit_selected_vas[$i]->id}} </h5>
                            <input type="hidden" name="edit_selected_vas[]" value="{{ $edit_selected_vas[$i]->id }}">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="form-group{{ $errors->has('vas_availability_batupahat') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">VAS Availability in Batu Pahat</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="vas_availability_batupahat[]" class="form-control" name="vas_availability_batupahat[]" placeholder="VAS Availability in Batu Pahat" value="{{$edit_selected_vas[$i]->vas_availability_batupahat}}">
                                ...
                                <div class="form-group{{ $errors->has('vas_availability_batupahat') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">VAS Availability in Johor Bahru</label>

                                    <div class="col-sm-10">
                                        <input type="text" id="vas_availability_johorbahru[]" class="form-control" name="vas_availability_johorbahru[]" placeholder="VAS Availability in Johor Bahru" value="{{$edit_selected_vas[$i]->vas_availability_johorbahru}}">
                                ...
                                <div class="form-group{{ $errors->has('vas_availability_muar') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">VAS Availability in Muar</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="vas_availability_muar[]" class="form-control" name="vas_availability_muar[]" placeholder="VAS Availability in Muar" value="{{$edit_selected_vas[$i]->vas_availability_muar}}">
                                ...
                                <div class="form-group{{ $errors->has('vas_availability_segamat') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">VAS Availability in Segamat</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="vas_availability_segamat[]" class="form-control" name="vas_availability_segamat[]" placeholder="VAS Availability in Segamat" value="{{$edit_selected_vas[$i]->vas_availability_segamat}}">
                                ...
                                <div class="form-group{{ $errors->has('vas_availability_kulaijaya') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">VAS Availability in Kulaijaya</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="vas_availability_kulaijaya[]" class="form-control" name="vas_availability_kulaijaya[]" placeholder="VAS Availability in Kulaijaya" value="{{$edit_selected_vas[$i]->vas_availability_kulaijaya}}">
