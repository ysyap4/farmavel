                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="POST" class="form-horizontal" action="{{ URL::route ('manage_report_create_process')}}">
                                ...
                                <div class="form-group{{ $errors->has('rep_image') ? ' has-error' : '' }}"><label class="col-sm-2 control-label">Report Image</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group">
                                                <label title="Upload image file" for="inputImage" class="btn btn-primary">
                                                    <input type="file" accept="image/*" name="rep_image" value=" " id="inputImage" class="hide">
                                                    Upload new image
                                                </label>
                                            </div>
                                        </div>
