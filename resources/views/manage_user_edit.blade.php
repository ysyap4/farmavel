                ...
                <div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit User ID {{$edit_selected_user[$i]->id}} </h5>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="btn-group">
                                                <label title="Upload image file" for="inputImage" class="btn btn-primary">
                                                    <input type="file" accept="image/*" name="image[]" class="inputImage" set-to="change_image{{$i}}" style="display: none; border: 1px solid #ccc; padding: 6px 12px; cursor: pointer;">
                                                    Upload new image
                                                </label>
                                            </div>
                                        </div>
